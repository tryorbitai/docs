...
let researcher = Agent(
    ...
    purpose: "Gather and analyze market information",
    context: "Expert in market research and data analysis"
)

let writer = Agent(
    role: "Content Creator", 
    purpose: "Create compelling marketing content",
    context: "Experienced copywriter and content strategist"
)

// Define tasks
let researchTask = Task(
    description: "Research AI market trends for Q4 2024",
    expectedOutput: "Comprehensive market analysis with key insights"
)

let contentTask = Task(
    description: "Create marketing content based on research findings", 
    expectedOutput: "Marketing copy highlighting key market opportunities"
)

// Create and execute orbit
let orbit = try Orbit(
    agents: [researcher, writer],
    tasks: [researchTask, contentTask], 
    process: .sequential
)
